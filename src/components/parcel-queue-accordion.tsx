          ...
          {lazyView ? (
            <div className="grid min-w-0 flex-1 grid-cols-1 gap-4 text-left sm:grid-cols-2">
              <div className="space-y-1">
                ...
                <p className="line-clamp-4 text-xl font-semibold leading-snug tracking-tight">
        ...
        <AccordionContent className="flex flex-col gap-5 pb-2">
          ...
          {lazyView ? (
            <>
              ...
              {order.note.trim() ? (
                <div className="space-y-2">
                  <p className="text-[0.65rem] font-semibold uppercase tracking-wider text-amber-900/90 dark:text-amber-400/90">
                    Note
                  </p>
                  <div
                    className={cn(
